...
describe('Cosmetic filters', () => {
    ...
    // });
    it('#getScript', () => {
        const parsed = cosmetic_1.default.parse('foo.com##+js(script.js, arg1, arg2, arg3)');
        (0, chai_1.expect)(parsed).not.to.be.null;
        if (parsed !== null) {
            (0, chai_1.expect)(parsed.getScript(new Map([['script.js', '{{1}},{{2}},{{3}}']]))).to.equal('arg1,arg2,arg3');
            (0, chai_1.expect)(parsed.getScript(new Map())).to.be.undefined;
        }
    });
    describe('#getTokens', () => {
